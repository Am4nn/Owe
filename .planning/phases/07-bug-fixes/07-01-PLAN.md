...
### BUG-16 — GO_BACK not handled after leaving group on web 🔧 FIX APPLIED — pending verification
...
### BUG-17 — FAB child buttons / "coming soon" popups not working on web 🔧 FIX APPLIED — pending verification
...
| TBD | BUG-16 + BUG-17: fix GO_BACK error + FAB web issues |
