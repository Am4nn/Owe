...
5. Create group: Tap + FAB, enter group name "Test Group", add named member "Charlie". Tap Create. Navigates to group detail showing two members (you + Charlie). Charlie shows "Not on Owe" label.
