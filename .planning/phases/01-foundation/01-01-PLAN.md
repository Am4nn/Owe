...
export default function DashboardScreen() {
  return (
    <View className="flex-1 bg-dark-bg items-center justify-center">
      <Text className="text-brand-primary text-3xl font-bold">Nexus</Text>
...
<success_criteria>
- App opens in the EAS dev client (not Expo Go) showing the dark (#0A0A0F) background dashboard screen with "Nexus" in electric purple (#6C63FF)
